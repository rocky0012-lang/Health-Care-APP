...
export const PatientSignupForm = ({
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      if (!baseUrl) {
        throw new Error("Missing app base URL for Google sign up.")
      }

      const oauthUrl = await beginGoogleOAuthSession({
        successUrl: `${baseUrl}/auth/oauth/callback`,
        ...
        <CardContent className="grid p-0">
          <form className="p-6 " onSubmit={form.handleSubmit(onSubmit)}>
            <FieldGroup>
              ...
              <Field className="grid gap-3 sm:grid-cols-3">
                <Button variant="outline" type="button" className="h-12 w-full gap-2 rounded-xl sm:h-11" disabled={isGoogleLoading}>
                ...
                <Button
                  variant="outline"
                  type="button"
                  className="h-12 w-full gap-2 rounded-xl sm:h-11"
