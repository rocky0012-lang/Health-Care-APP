...
const faqs = [
  {
    ...
    answer: 'Register an account, choose your doctor, and select a slot.',
  },
  {
    question: 'What should I bring to my first visit?',
    answer: 'Your ID and any previous medical records.',
  },
  {
  ...
  },
  {
    ...
    answer: 'You can manage all your bookings through your patient dashboard.',
  },
]
...
export default function LandingPageClient({ isAdmin }: LandingPageClientProps) {
                ...
                return (
                  <div key={faq.question} className="rounded-2xl border border-white/10 bg-white/5 p-5">
                    ...
                    >
                      ...
                      <span className="mt-0.5 inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-white/15 bg-white/5 text-lg font-semibold text-indigo-200">
                        {isOpen ? '−' : '+'}
                      </span>
                    </button>

                    {isOpen && (
                      <p className="mt-4 pr-10 text-sm leading-7 text-gray-300 sm:text-base">
                        {faq.answer}
                      </p>
                    )}
                  </div>
